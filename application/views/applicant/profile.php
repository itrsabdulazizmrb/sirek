    ...
    <div class="card">
      <div class="card-header pb-0">
        <div class="d-flex align-items-center">
          ...
          <a href="<?= base_url('applicant/change_password') ?>" class="btn btn-primary btn-sm ms-auto">Change Password</a>
        </div>
      </div>
      <div class="card-body">
        <?= form_open_multipart('applicant/profile', ['class' => 'needs-validation']) ?>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="full_name" class="form-control-label">Full Name</label>
                <input type="text" name="full_name" id="full_name" class="form-control" value="<?= set_value('full_name', $user->full_name) ?>" required>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="phone" id="phone" class="form-control" value="<?= set_value('phone', $user->phone) ?>" required>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="date" name="date_of_birth" id="date_of_birth" class="form-control" value="<?= set_value('date_of_birth', $profile->date_of_birth) ?>" required>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="address" id="address" class="form-control" rows="3" required><?= set_value('address', $user->address) ?></textarea>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="gender" id="gender" class="form-control" required>
                  ...
                  <option value="male" <?= set_select('gender', 'male', ($profile->gender == 'male')) ?>>Male</option>
                  <option value="female" <?= set_select('gender', 'female', ($profile->gender == 'female')) ?>>Female</option>
                  <option value="other" <?= set_select('gender', 'other', ($profile->gender == 'other')) ?>>Other</option>
                </select>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="education" id="education" class="form-control" rows="3" required><?= set_value('education', $profile->education) ?></textarea>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="experience" id="experience" class="form-control" rows="3" required><?= set_value('experience', $profile->experience) ?></textarea>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="skills" id="skills" class="form-control" rows="3" required><?= set_value('skills', $profile->skills) ?></textarea>
            ...
            <div class="col-md-6">
              <?php if ($profile->resume) : ?>
                <div class="form-group">
                  ...
                  <p class="mb-0"><?= $profile->resume ?></p>
                  <a href="<?= base_url('uploads/resumes/' . $profile->resume) ?>" class="btn btn-sm btn-outline-primary mt-2" target="_blank">View Resume</a>
                </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="url" name="linkedin_url" id="linkedin_url" class="form-control" value="<?= set_value('linkedin_url', $profile->linkedin_url) ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="portfolio_url" class="form-control-label">Portfolio URL</label>
                <input type="url" name="portfolio_url" id="portfolio_url" class="form-control" value="<?= set_value('portfolio_url', $profile->portfolio_url) ?>">
              </div>
            </div>
          </div>
