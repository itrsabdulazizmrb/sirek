        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="d-flex mb-4">
              <span class="badge badge-sm bg-gradient-<?= $application->job_type == 'full-time' ? 'success' : ($application->job_type == 'part-time' ? 'info' : ($application->job_type == 'contract' ? 'warning' : 'secondary')) ?> me-2"><?= $application->job_type == 'full-time' ? 'Full Time' : ($application->job_type == 'part-time' ? 'Part Time' : ($application->job_type == 'contract' ? 'Kontrak' : 'Magang')) ?></span>
              <span class="text-sm me-3"><i class="ni ni-pin-3 me-1"></i> <?= $application->location ?></span>
            ...
            <div class="timeline timeline-one-side">
              ...
              <?php if (in_array($application->status, ['shortlisted', 'interviewed', 'offered', 'hired'])) : ?>
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Masuk Shortlist</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0"><?= date('d M Y', strtotime($application->updated_at)) ?></p>
                  </div>
                </div>
              <?php endif; ?>
          ...
          <div class="col-md-12">
            ...
            <?= form_open('admin/add_application_note/' . $application->id) ?>
              <div class="form-group">
                <textarea class="form-control" name="note" rows="3" placeholder="Tambahkan catatan tentang pelamar ini..."><?= $application->admin_notes ?></textarea>
              </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-center mt-4">
          <a href="<?= base_url('admin/applicant_profile/' . $applicant->id) ?>" class="btn btn-sm btn-outline-primary">Lihat Profil Lengkap</a>
        </div>
      </div>
    </div>
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-center">
          <a href="<?= base_url('admin/edit_job/' . $job->id) ?>" class="btn btn-sm btn-outline-primary">Lihat Detail Lowongan</a>
        </div>
      </div>
    </div>
  </div>
