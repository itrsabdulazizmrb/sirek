    ...
    <div class="col-md-4">
      <div class="card move-on-hover">
        <div class="card-body text-center">
          ...
          <a href="<?= base_url('auth/daftar') ?>" class="btn btn-outline-primary mt-3">Sign Up</a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-12">
      <div class="card card-body border-0 shadow-xl mt-n5">
                ...
                <div class="card h-100">
                  ...
                  <div class="card-body pt-3">
                    ...
                    <div class="d-flex align-items-center mt-3">
                      <a href="<?= base_url('lowongan/' . $job->id) ?>" class="btn btn-outline-primary btn-sm mb-0">View Details</a>
        ...
        <div class="text-center mt-4">
          <a href="<?= base_url('lowongan') ?>" class="btn bg-gradient-primary">View All Jobs</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="text-center mt-4">
            <a href="<?= base_url('tentang') ?>" class="btn btn-outline-primary btn-sm mb-0">Learn More</a>
          </div>
        </div>
      </div>
    </div>
